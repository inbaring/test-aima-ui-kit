Pod::Spec.new do |spec|
  spec.name          = 'testaimaUIKit'
  spec.version       = '1.0'
  spec.license       = { :type => 'MIT' }
  spec.homepage      = 'http://www.animaapp.com'
  spec.authors       = { 'adiiinbar@gmail.com' => '' }
  spec.summary       = 'testaima UI Kit'
  spec.source        = { :git => '' }
  spec.source_files  = 'testaimaUIKit/*.{h,m,swift}'
  ...
  spec.resources     = ['testaimaUIKit/**/*.{xcassets,storyboard}', 'testaimaUIKit/Resources/**/*.*']
